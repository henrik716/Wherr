...
! function() {
    ...
    window.Framework7 = function(a) {
            ...
            if (!i.params.material) {
                ...
                a.each(function() {
                    ...
                    if (!e.hasClass("cached")) {
                        ...
                        var w = t;
                        i.rtl && p && d && s.length > 0 && (w = -w), s.css({
                            left: w + "px"
                        })
                    }
                })
        ...
        i.modalStack = [], i.modalStackClearQueue = function() {
            ...
            function n() {
                ...
                if (s) {
                    ...
                    "top" === w && t.addClass("on-bottom"), "bottom" === w && t.addClass("on-top"), b -= v, n = i / 2 - p + b, n = Math.max(Math.min(n, i - 2 * p - 13), 13), t.css({
                        left: n + "px"
            ...
            function t() {
                ...
                if (0 !== a.length) {
                    var t, n = parseInt(a.css("padding-top"), 10),
                        ...
                        i = a[0].offsetHeight - n - re.height(),
                        s = a[0].scrollHeight - n - re.height(),
                        o = e.offset().top - n + e[0].offsetHeight;
                    if (o > i) {
                        var l = a.scrollTop() + o - i;
                        l + i > s && (t = l + i - s + r, i === s && (t = re.height()), a.css({
                            "padding-bottom": t + "px"
                        })), a.scrollTop(l, 300)
                    }
                }
            ...
            if (e = o(e), 0 !== e.length) {
                ...
                if (0 !== d.length) {
                    ...
                    if (!(k.disabled || e.hasClass("disabled") || P.hasClass("disabled"))) {
                        ...
                        var ne, re, ie = '<form class="searchbar searchbar-init" data-search-list=".smart-select-list-' + V + '" data-search-in=".item-title"><div class="searchbar-input"><input type="search" placeholder="' + $ + '"><a href="#" class="searchbar-clear"></a></div>' + (x ? "" : '<a href="#" class="searchbar-cancel">' + ee + "</a>") + '</form><div class="searchbar-overlay"></div>',
                ...
                if ("undefined" != typeof a && (t = a), null === r.lastRepaintY || Math.abs(t - r.lastRepaintY) > h || !s && r.pageContent[0].scrollTop + p >= r.pageContent[0].scrollHeight) {
                    ...
                    for (var w = n; i > w; w++) {
                        ...
                        y = r.items.indexOf(o[w]), w === n && (r.currentFromIndex = y), w === i - 1 && (r.currentToIndex = y), y === r.items.length - 1 && (r.reachEnd = !0), r.domCache[y] ? C = r.domCache[y] : (r.template ? r.tempDomElement.innerHTML = r.template(o[w], {
                            index: y
                        }) : r.params.renderItem ? r.tempDomElement.innerHTML = r.params.renderItem(y, o[w]) : r.tempDomElement.innerHTML = o[w], C = r.tempDomElement.childNodes[0], r.params.cache && (r.domCache[y] = C)), C.f7VirtualListIndex = y, w === n && (b = g ? l : w * r.params.height / r.params.cols), C.style.top = b + "px", r.params.onItemBeforeInsert && r.params.onItemBeforeInsert(r, C), r.fragment.appendChild(C)
                    }
        ...
        var v = function(e) {
            ...
            var C, y, x, T, k, P, S, M, I, O, E, D, L, B, N, z, A, H = {},
                R = {};
        ...
        var b = function(e) {
            ...
            if (!a.params.input || (a.input = o(a.params.input), 0 !== a.input.length || "dropdown" !== a.params.openIn)) {
                ...
                if ("dropdown" !== a.params.openIn) {
                    ...
                    var c, u, m = "autocomplete-" + a.inputName,
                        f = a.params.navbarTheme,
                        h = a.params.formTheme,
                        g = "",
                        v = "";
                ...
                return a.popup = void 0, a.dropdown = void 0, a.handleInputValue = function(e) {
                    ...
                    a.params.source && a.params.source(a, t, function(e) {
                        var n = "",
                            r = a.params.limit ? Math.min(a.params.limit, e.length) : e.length;
                        a.items = e;
                        ...
                        "" === n && "" === t && a.params.dropdownPlaceholderText && (n += a.dropdownPlaceholderTemplate({
                            text: a.params.dropdownPlaceholderText
                        })), a.dropdown.find("ul").html(n)
                    })
                    ...
                    var e = a.input.parents(".list-block"),
                        t = a.input.parents(".page-content"),
                    ...
                    if (n.name === m) {
                        ...
                        i.searchbar(l.find(".searchbar"), {
                            ...
                            onSearch: function(e, t) {
                                ...
                                a.params.source && a.params.source(a, t.query, function(e) {
                                    var i = "",
                                        o = a.params.limit ? Math.min(a.params.limit, e.length) : e.length;
                                    for (a.items = e, n = 0; o > n; n++) {
                                        var p = !1,
                                            d = "object" == typeof e[n] ? e[n][a.params.valueProperty] : e[n];
                        ...
                        l.on("change", 'input[type="radio"], input[type="checkbox"]', function() {
                            ...
                            if (u) {
                                ...
                                if ("radio" === a.inputType) a.value = [n];
                                else if (d.checked) a.value.push(n);
                                else
                                    for (e = 0; e < a.value.length; e++) l = "string" == typeof a.value[e] ? a.value[e] : a.value[e][a.params.valueProperty], (l === c || 1 * l === 1 * c) && a.value.splice(e, 1);
                    ...
                    if (!a.opened)
                        if (a.opened = !0, "dropdown" === a.params.openIn) {
    ...
    window.Dom7 = e, Framework7.prototype.support = function() {
        ...
        var m = {};
        for (var f in n)
            if ("object" != typeof n[f] || (n[f].nodeType || n[f] === window || n[f] === document || "undefined" != typeof e && n[f] instanceof e || "undefined" != typeof jQuery && n[f] instanceof jQuery)) m[f] = n[f];
            else {
                m[f] = {};
        ...
        if (b.params = n, b.originalParams = m, b.classNames = [], "undefined" != typeof a && "undefined" != typeof e && (a = e), ("undefined" != typeof a || (a = "undefined" == typeof e ? window.Dom7 || window.Zepto || window.jQuery : e)) && (b.$ = a, b.currentBreakpoint = void 0, b.getActiveBreakpoint = function() {
            ...
            b.container[0].swiper = b, b.container.data("swiper", b), b.classNames.push("swiper-container-" + b.params.direction), b.params.freeMode && b.classNames.push("swiper-container-free-mode"), b.support.flexbox || (b.classNames.push("swiper-container-no-flexbox"), b.params.slidesPerColumn = 1), b.params.autoHeight && b.classNames.push("swiper-container-autoheight"), (b.params.parallax || b.params.watchSlidesVisibility) && (b.params.watchSlidesProgress = !0), ["cube", "coverflow"].indexOf(b.params.effect) >= 0 && (b.support.transforms3d ? (b.params.watchSlidesProgress = !0, b.classNames.push("swiper-container-3d")) : b.params.effect = "slide"), "slide" !== b.params.effect && b.classNames.push("swiper-container-" + b.params.effect), "cube" === b.params.effect && (b.params.resistanceRatio = 0, b.params.slidesPerView = 1, b.params.slidesPerColumn = 1, b.params.slidesPerGroup = 1, b.params.centeredSlides = !1, b.params.spaceBetween = 0, b.params.virtualTranslate = !0, b.params.setWrapperSize = !1), "fade" === b.params.effect && (b.params.slidesPerView = 1, b.params.slidesPerColumn = 1, b.params.slidesPerGroup = 1, b.params.watchSlidesProgress = !0, b.params.spaceBetween = 0, "undefined" == typeof u && (b.params.virtualTranslate = !0)), b.params.grabCursor && b.support.touch && (b.params.grabCursor = !1), b.wrapper = b.container.children("." + b.params.wrapperClass), b.params.pagination && (b.paginationContainer = a(b.params.pagination), b.params.paginationClickable && b.paginationContainer.addClass("swiper-pagination-clickable")), b.rtl = r() && ("rtl" === b.container[0].dir.toLowerCase() || "rtl" === b.container.css("direction")), b.rtl && b.classNames.push("swiper-container-rtl"), b.rtl && (b.wrongRTL = "-webkit-box" === b.wrapper.css("display")), b.params.slidesPerColumn > 1 && b.classNames.push("swiper-container-multirow"), b.device.android && b.classNames.push("swiper-container-android"), b.container.addClass(b.classNames.join(" ")), b.translate = 0, b.progress = 0, b.velocity = 0, b.lockSwipeToNext = function() {
                ...
                if (b.rtl && b.wrongRTL && ("slide" === b.params.effect || "coverflow" === b.params.effect) && b.wrapper.css({
                    ...
                    }), (!b.support.flexbox || b.params.setWrapperSize) && (r() ? b.wrapper.css({
                        width: b.virtualSize + b.params.spaceBetween + "px"
                    }) : b.wrapper.css({
                ...
                0 === b.snapGrid.length && (b.snapGrid = [0]), 0 !== b.params.spaceBetween && (r() ? b.rtl ? b.slides.css({
                    marginLeft: a + "px"
                }) : b.slides.css({
                    marginRight: a + "px"
                }) : b.slides.css({
            ...
            b.onTouchStart = function(e) {
                ...
                if (e.originalEvent && (e = e.originalEvent), x && b.emit("onTouchEnd", b, e), x = !1, C) {
                    ...
                    if (r = b.params.followFinger ? b.rtl ? b.translate : -b.translate : -P, b.params.freeMode) {
                        ...
                        if (b.params.freeModeMomentum) {
                            ...
                            if (c < b.maxTranslate()) b.params.freeModeMomentumBounce ? (c + b.maxTranslate() < -f && (c = b.maxTranslate() - f), u = b.maxTranslate(), m = !0, O = !0) : c = b.maxTranslate();
                            else if (c > b.minTranslate()) b.params.freeModeMomentumBounce ? (c - b.minTranslate() > f && (c = b.minTranslate() + f), u = b.minTranslate(), m = !0, O = !0) : c = b.minTranslate();
                ...
                cube: {
                    setTranslate: function() {
                        var e, t = 0;
                        b.params.cube.shadow && (r() ? (e = b.wrapper.find(".swiper-cube-shadow"), 0 === e.length && (e = a('<div class="swiper-cube-shadow"></div>'), b.wrapper.append(e)), e.css({
                            height: b.width + "px"
                        ...
                        if (b.wrapper.css({
                            ...
                            if (r()) e.transform("translate3d(0px, " + (b.width / 2 + b.params.cube.shadowOffset) + "px, " + -b.width / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + b.params.cube.shadowScale + ")");
                            else {
                ...
                coverflow: {
                    setTranslate: function() {
                        for (var e = b.translate, t = r() ? -e + b.width / 2 : -e + b.height / 2, n = r() ? b.params.coverflow.rotate : -b.params.coverflow.rotate, i = b.params.coverflow.depth, s = 0, o = b.slides.length; o > s; s++) {
                            var l = b.slides.eq(s),
                                p = b.slidesSizesGrid[s],
                                d = l[0].swiperSlideOffset,
                                c = (t - d - p / 2) / p * b.params.coverflow.modifier,
                                u = r() ? n * c : 0,
                                m = r() ? 0 : n * c,
                                f = -i * Math.abs(c),
                                h = r() ? 0 : b.params.coverflow.stretch * c,
